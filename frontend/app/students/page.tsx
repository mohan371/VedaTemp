  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-wrap">
                ...
                <Link href="/book-counselling">
                  <Button
                    variant="outline"
                    className="px-8 py-4 text-lg w-full sm:w-auto hover:scale-105 transition-all text-white border-white/20 hover:bg-white/10"
                  >
                ...
                <Button
                  variant="outline"
                  className="px-8 py-4 text-lg w-full sm:w-auto hover:scale-105 transition-all border-[var(--gold)] text-[var(--gold)] hover:bg-[var(--gold)] hover:text-[var(--blue-darkest)]"
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <div
                  className={`px-8 transition-all duration-300 ease-in-out ${openFaq === index
      ...
      <BrochureModal
        ...
        pdfUrl="/brochures/Veda-Scholars-Student-Brochure.pdf"
        downloadFileName="Veda-Scholars-Student-Brochure.pdf"
        footerText="Start your international career journey with Veda Scholars"
      />
    </main>
  );
}
