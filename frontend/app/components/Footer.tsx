    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto text-center w-full">
          ...
          >
            <Button variant="primary" href="/book-counselling" className="w-full sm:w-auto sm:min-w-[200px] px-8 py-3 h-12 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold border-none">
              Book Your Free Counselling Today!
            </Button>
            <Button variant="outline" href="/partner" className="w-full sm:w-auto sm:min-w-[200px] px-8 py-3 h-12 border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black">
              Join as a Partner
            </Button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                {/* Social Icons */}
                <Link href="https://www.facebook.com/VedaScholars/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                </Link>
                <Link href="https://x.com/Veda_Scholars" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                ...
                <Link href="https://www.linkedin.com/company/veda-scholars/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" /></svg>
                </Link>
                <Link href="https://www.instagram.com/veda_scholars/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><Link href="/student-stories" className="text-white/80 hover:text-white transition-colors">Student Stories</Link></li>
                <li><Link href="/university-case-study" className="text-white/80 hover:text-white transition-colors">University Case Study</Link></li>
                <li><Link href="/blogs" className="text-white/80 hover:text-white transition-colors">Blogs</Link></li>
                <li><Link href="/careers" className="text-white/80 hover:text-white transition-colors">Campus Ambassador Programme</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/support" className="text-white/80 hover:text-white transition-colors">FAQ & Support Center</Link></li>
                <li><Link href="/get-in-touch" className="text-white/80 hover:text-white transition-colors">Get In Touch</Link></li>
                <li><Link href="/partner" className="text-white/80 hover:text-white transition-colors">Partner With Us</Link></li>
                <li><Link href="/partner" className="text-white/80 hover:text-white transition-colors">Recruit Talent</Link></li>
              </ul>
            </div>
          </div>
